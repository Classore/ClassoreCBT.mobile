...
const ROUTE_SECTIONS: RouteSection[] = [
  ...
  },
  {
    ...
    data: [
      { name: 'IELTS Setup (Section Order)', path: '/(exam)/ielts-setup?exam=42&exam_name=IELTS%20Academic' },
      { name: 'IELTS General Instructions', path: '/(exam)/ielts-instructions?exam=42&exam_name=IELTS%20Academic' },
      { name: 'IELTS Reading Instructions', path: '/(exam)/ielts-section-instructions?exam=42&exam_name=IELTS%20Academic&section_name=Reading' },
      { name: 'IELTS Reading Session', path: '/(exam)/ielts-session' },
      { name: 'IELTS Listening Instructions', path: '/(exam)/ielts-listening-instructions?exam=42&exam_name=IELTS%20Academic' },
      { name: 'IELTS Listening Session', path: '/(exam)/ielts-listening-session' },
  ...
  },
  {
    title: 'Contest Suite',
    data: [
      { name: 'Contest Zone (List)', path: '/(tabs)/contest', badge: 'New', badgeColor: '#16A34A' },
      { name: 'Contest Details (Join)', path: '/(tabs)/contest/details?id=1&registered=false' },
      { name: 'Contest Details (Registered)', path: '/(tabs)/contest/details?id=1&registered=true' },
      { name: 'Rules & Instructions', path: '/(tabs)/contest/rules?id=1' },
      { name: 'Registration Details', path: '/(tabs)/contest/register?id=1' },
      { name: 'Payment Method', path: '/(tabs)/contest/payment?id=1' },
      { name: 'Registration Successful', path: '/(tabs)/contest/success?id=1' },
      { name: 'Contest Leaderboard', path: '/(tabs)/contest/leaderboard?contestId=1' },
      { name: 'Contest Congratulations Modal', path: '/(tabs)/contest/leaderboard?contestId=1&showCelebration=true' },
    ],
  },
  {
    ...
    data: [
      ...
      { name: 'Bundles Directory', path: '/(tabs)/bundles', badge: 'New', badgeColor: '#7C3AED' },
      { name: 'Bundle Details', path: '/(tabs)/bundles/details' },
      { name: 'Bundle Payment', path: '/(tabs)/bundles/payment' },
      { name: 'Bundle Success', path: '/(tabs)/bundles/success' },
  ...
  },
  {
    ...
    data: [
      ...
      { name: 'Profile Settings', path: '/(tabs)/profile-settings', badge: 'New', badgeColor: '#6D28D9' },
      { name: 'Appearance', path: '/(tabs)/appearance', badge: 'New', badgeColor: '#6D28D9' },
      { name: 'Language', path: '/(tabs)/language', badge: 'New', badgeColor: '#6D28D9' },
      { name: 'Notification Preferences', path: '/(tabs)/notification-preferences', badge: 'New', badgeColor: '#6D28D9' },
      { name: 'Security', path: '/(tabs)/security', badge: 'New', badgeColor: '#6D28D9' },
      { name: 'Notifications Inbox', path: '/notifications' },
    ],
  },
  {
