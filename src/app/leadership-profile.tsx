...
export default function LeadershipProfileScreen() {
  ...
  // Dynamic user details with design defaults matching mockup
  const fullName = (user?.first_name || user?.last_name)
    ? `${user.first_name || ''} ${user.last_name || ''}`.trim()
    : 'Daniel Adekunle';
  const email = user?.email || 'daniel.adekunle@example.com';
  const phone = user?.phone_number || '+234 801 234 5678';
  const avatarUrl = (user as any)?.avatar_url || (user as any)?.avatar;

  // Overview metric items matching design specs
  ...
  // Subject Rankings matching design specs
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <AppText style={styles.headerTitle}>Leadership Profile</AppText>
          ...
          >
            ...
            <View style={styles.heroProfileRow}>
              ...
              <View style={styles.percentileBadge}>
                <AppText style={styles.percentileBadgeText}>Top 15%</AppText>
              </View>
            </View>
            ...
            <View style={styles.heroMetricsRow}>
              ...
              <View style={styles.heroMetricCol}>
                ...
                <AppText style={styles.heroMetricValue}>#1,248</AppText>
                <AppText style={styles.heroMetricSub}>of 12,540 students</AppText>
              </View>

              {/* Metric 2 */}
              <View style={styles.heroMetricCol}>
                <AppText style={styles.heroMetricLabel}>Average Score</AppText>
                <AppText style={styles.heroMetricValue}>245</AppText>
                <AppText style={styles.heroMetricSub}>Top 15%</AppText>
              </View>

              {/* Metric 3 */}
              <View style={styles.heroMetricCol}>
                <AppText style={styles.heroMetricLabel}>Token</AppText>
                <AppText style={styles.heroMetricValue}>2,450</AppText>
                <AppText style={styles.heroMetricSub}>Top 15%</AppText>
              </View>
            </View>
          </LinearGradient>
